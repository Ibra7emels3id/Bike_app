...
const Page = () => {
    ...
    return (
        <>
            <Header />
            <section>
                <div className="mx-auto max-w-screen-4xl px-4 py-32 sm:px-6 sm:py-32 lg:px-8">
                    <header>
                    ...
                    <div className="mt-4 lg:mt-8 lg:grid lg:grid-cols-4 lg:items-start lg:gap-8">
                        <div className="hidden space-y-4 lg:block">
                            <div>
                                ...
                                <select onChange={()=>{
                                    handleChange()
                                }} id="SortBy" className="mt-1 rounded border-gray-300 text-sm w-full border-spacing-1 border h-12 px-3">
                                    <option hidden>Sort By</option>
                                    <option value="All">Title, DESC</option>
