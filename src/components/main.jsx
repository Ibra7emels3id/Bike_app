...
const Main = () => {
    return (
        <>
            <section
                className="relative bg-imgs bg-[url(https://surlybikes.com/uploads/bikes/_medium_image/Lowside_BK0534_Background-2000x1333.jpg)] "
            >
                <div
                ...
                >
                    <div className="main-text max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
